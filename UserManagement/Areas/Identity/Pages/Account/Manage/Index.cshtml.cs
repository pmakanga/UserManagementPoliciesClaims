    ...
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
          ...
          //  UserNameChangeLimitMessage = $"You can change your username {user.UsernameChangeLimit} more time(s).";
            ...
            var firstName = user.FirstName; // newly added logic for firstname and lastname
            var lastName = user.LastName;
            ...
            //logic to save/update remaining attempts left to change the username
